...
#define SWD_SWDIO (BSP_IO_PORT_01_PIN_08)
#define ARDUINO_D1_PMOD2_MOSI9 (BSP_IO_PORT_01_PIN_09)
#define ARDUINO_D0_PMOD2_MISO9 (BSP_IO_PORT_01_PIN_10)
...
#define SWD_SWCLK (BSP_IO_PORT_03_PIN_00)
